...
function Home() {
  return (
    <div name='home' className="w-full h-screen bg-[#011343]">
      {/* container */}
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <div>
          <button className="text-white max-w-[200px] group border-2 px-6 py-3 my-2 flex items-center hover:bg-pink-600 hover:border-pink-600">
            View Work 
